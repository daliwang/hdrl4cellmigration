...
parser.add_argument("--emb", type=int, default=3, help="The index of Cpaaa embryo. choose from [1,2,3,4]") #100
...
if args.emb == 1:
	...
	END_POINT = 125
	PLANE_DRAW = 7
	# NUCLEI_DATA_PATH = '/Users/ziwang/Documents/work/deep_worm/multi-embryo/WT50/zhuo_wt_RW10348/ZD_RW10348_WT_20110427_3_s4_emb1_edited/nuclei/'
	...
	END_POINT = 137-4
	PLANE_DRAW = 7
	# NUCLEI_DATA_PATH = '/Users/ziwang/Documents/work/deep_worm/multi-embryo/WT50/zhuo_wt_BV82/ZD_BV82_WT_20110419_3_s2_emb1_edited/nuclei/'
	...
	END_POINT = 135-7
	PLANE_DRAW = 7
	# NUCLEI_DATA_PATH = '/Users/ziwang/Documents/work/deep_worm/multi-embryo/WT50/zhuo_wt_RW10348/ZD_RW10348_WT_20110126_2_s2_emb2_edited/nuclei/'
	...
	END_POINT = 133-9
	PLANE_DRAW = 7
	# NUCLEI_DATA_PATH = '/Users/ziwang/Documents/work/deep_worm/multi-embryo/WT50/zhuo_wt_RW10714/ZD_RW10714_WT_20110724_1_s3_emb1_edited/nuclei/'
...
class SeqRosModel(Model):
	def __init__(self):
		...
		self.speed_model_plus.load_state_dict(torch.load('./trained_models/motion_model.pkl', map_location=lambda storage, loc: storage))
